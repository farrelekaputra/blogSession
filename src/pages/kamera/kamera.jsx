        ...
        <article className="content flex flex-col mx-auto w-full md:p-4 rounded-md">
          ...
          <MainText 
            teks={[
              ...
              "Terus, setelah beberapa waktu mulai nikmatin kamera ini dan pede sama hasil sendiri mulai bikin deh akun yang isinya jepretan random si katuba (kamera tua bangka biar gampang nyebutnya) ini. Promosi dikit boleh kali, kalian bisa ngecek sendiri atau klik akun disamping namanya <a href='https://www.instagram.com/paralell25/' target='_blank' rel='noopener noreferrer' class='text-blue-500 underline font-medium'>  @paralell25 </a> disitu udah ada beberapa jepretan random. Gak lama setelah itu, diundang sama temen yang udah selesai sidang skripsi (selamat yah), dan inisiatif bawa kamera buat dokumentasiin momen. Sedikit banyak kejadian, trus dibilang deh hasil foto-foto ini udah lumayan proper. Jadiyah keliatannya mulai pede buat abadiin momen orang lain pake katuba ini (kalian juga yang lagi baca misal ada undangan sidang/wisuda bisa kali kontak hehe)."
            ]}
          />
          <Image 
            gambar={gambar3}
